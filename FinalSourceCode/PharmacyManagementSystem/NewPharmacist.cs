...
namespace PharmacyManagementSystem
{
    public partial class NewPharmacist : Form
    {
        ...
        private void btnNewPharmacistCreate_Click(object sender, EventArgs e)
        {
            ...
            if (newOwnerNameTextBox.Text == "" || nidTextBox.Text == "" || shopNameTextBox.Text == "" || mobileTextBox.Text == "" 
                    || locationTextBox.Text == "" || emailTextBox.Text == "" || passwordTextBox.Text == "" || confirmPasswordText.Text == "")
            {
                MessageBox.Show("Some fields are empty", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                if (passwordTextBox.Text == confirmPasswordText.Text)
                {
