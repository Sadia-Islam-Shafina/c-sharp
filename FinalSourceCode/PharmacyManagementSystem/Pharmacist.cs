...
namespace PharmacyManagementSystem
{
    public partial class Pharmacist : Form
    {
        ...
        private void btnRemoveFromStore_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            string query = "DELETE MedicineInfo where Name=@name";
            cmd.CommandText = query;
            cmd.Parameters.AddWithValue("@name", medNameTextBox.Text);
            try
            {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            string query = "Update MedicineInfo set Quantity=@quantity where Name=@name";
            cmd.CommandText = query;
            cmd.Parameters.AddWithValue("@name", medNameTextBox.Text);
            cmd.Parameters.AddWithValue("@quantity", medQuantityTextBox.Text);
            try
        ...
        private void btnSearchPharmacist_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            string query = "select * from MedicineInfo where Name=@name";
            cmd.CommandText = query;
            cmd.Parameters.AddWithValue("@name", medNameTextBox.Text);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
