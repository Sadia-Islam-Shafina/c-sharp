...
namespace PharmacyManagementSystem
{
    public partial class NewUser : Form
    {
        ...
        {
            if (newUserNameTextBox.Text == "" || dobTextBox.Text == "" || newUserMobileNumberTextBox.Text == "" || newUserEmailAddressTextBox.Text == ""
                    || newUserUserNameTextBox.Text == "" || newUserConfirmPasswordTextBox.Text == "")
            {
                MessageBox.Show("Some fields are empty", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                if (newUserPasswordTextBox.Text == newUserConfirmPasswordText.Text)
                {
                    ...
                    cmd.Parameters.AddWithValue("@mobile", int.Parse(newUserMobileNumberTextBox.Text));
